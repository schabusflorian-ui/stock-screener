...
export function WatchlistProvider({ children }) {
  ...
  const addToWatchlist = useCallback(async (symbol, name, sector, companyId) => {
  ...
  }, [watchlist, isAuthenticated, user?.id]);
  ...
  const addPriceAlert = useCallback((symbol, type, targetPrice, note = '') => {
    const newAlert = {
  ...
  // Only recreates when actual data or function dependencies change
