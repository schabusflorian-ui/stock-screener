...
/**
 * Card Component - Prism Design System
 *
 * A versatile card container following the Prism design tokens.
 *
 * Variants:
 * - base: Standard card with white background and subtle border
 * - elevated: Card with shadow for emphasis
 * - interactive: Hoverable card with transition effects
 * - ai: Card with gradient accent for AI features
 *
 * Padding:
 * - sm: 12px (var(--space-3))
 * - md: 16px (var(--space-4))
 * - lg: 20px (var(--space-5)) - Default
 * - none: No padding
 */
function Card({
  variant = 'base',
...
Card.propTypes = {
  variant: PropTypes.oneOf(['base', 'elevated', 'interactive', 'ai']),
