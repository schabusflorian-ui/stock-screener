 ...
 * Row components are memoized to prevent unnecessary re-renders in large tables.
 */
...
// Table Row - memoized for virtualization and large list performance
const TableRow = memo(function TableRow({ className = '', onClick, children, ...props }) {
  const classes = [
    'ui-table__row',
...
// Table Data Cell - memoized for performance in large tables
const TableCell = memo(function TableCell({ align = 'left', className = '', children, ...props }) {
  return (
