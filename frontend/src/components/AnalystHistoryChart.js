...
import { TrendingUp, TrendingDown, Target, Users, Calendar, RefreshCcw, History } from './icons';
...
export function AnalystHistoryChart({ symbol }) {
  ...
  return (
    <div className="analyst-history-container" {...askAIProps}>
      {/* Header */}
        ...
        <div className="analyst-history-chart">
          <ResponsiveContainer width="100%" height={280}>
            <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              {/* Target range area - FT-style 0.15 opacity */}
              <Area
                type="monotone"
                dataKey="targetHigh"
                stroke="none"
        ...
        <div className="analyst-history-chart">
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <Bar dataKey="strongBuy" stackId="a" fill="#059669" name="Strong Buy" />
              <Bar dataKey="buy" stackId="a" fill="#10B981" name="Buy" />
              <Bar dataKey="hold" stackId="a" fill="#D97706" name="Hold" />
              <Bar dataKey="sell" stackId="a" fill="#DC2626" name="Sell" />
              <Bar dataKey="strongSell" stackId="a" fill="#DC2626" name="Strong Sell" />
            </BarChart>
          </ResponsiveContainer>
