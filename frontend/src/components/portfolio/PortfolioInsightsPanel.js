...
import { Bot, Sparkles, RefreshCw, ChevronRight, AlertTriangle, TrendingUp, Shield, PieChart, Loader } from 'lucide-react';
...
${sectorBreakdown}`;
  ...
  return (
    <div className={`portfolio-insights-panel ${expanded ? 'expanded' : ''}`}>
