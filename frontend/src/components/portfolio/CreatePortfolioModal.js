...
import { X, Plus, Wallet, Loader, PieChart, BarChart3, TrendingUp, Shield, Zap, DollarSign, Users, Search, Trash2, Layers, ChevronRight, ChevronDown, Briefcase, BookOpen } from '../icons';
...
// Risk colors matching Prism Design System semantic tokens
// --positive: #059669, --warning-dark: #D97706, --negative: #DC2626
const RISK_COLORS = {
  'low': '#059669',        // var(--positive)
  'medium-low': '#059669', // var(--positive)
  'medium': '#D97706',     // var(--warning-dark)
  'high': '#DC2626'        // var(--negative)
};
                ...
                {loadingModels ? (
                  ...
                  <div className="model-grid">
                    {models.map(model => {
                      ...
                      const riskColor = RISK_COLORS[model.risk_level] || '#94A3B8';
