...
import { AlertTriangle, TrendingDown, Target, Shield, Zap, ChevronDown, ChevronUp } from 'lucide-react';
          ...
          <div className="action-items">
            ...
            <div className="actions-grid">
              <div className="action-card">
                <Target size={18} className="action-icon" />
              ...
              <div className="action-card">
                <Shield size={18} className="action-icon" />
                <div className="action-content">
              ...
              <div className="action-card">
                <TrendingDown size={18} className="action-icon" />
                <div className="action-content">
