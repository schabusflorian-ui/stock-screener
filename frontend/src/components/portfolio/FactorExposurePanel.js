...
import { Loader, AlertTriangle, PieChart, TrendingUp, DollarSign, Activity, RefreshCw, BarChart3, Info } from 'lucide-react';
                      ...
                      <div className="ff-returns-section">
                        ...
                        <ResponsiveContainer width="100%" height={250}>
                          <LineChart data={factorReturns}>
                            ...
                            />
                            <Legend />
                            <Line type="monotone" dataKey="mkt" stroke="#3b82f6" name="Market" dot={false} strokeWidth={2} />
                            <Line type="monotone" dataKey="smb" stroke="#10b981" name="Size" dot={false} strokeWidth={1.5} />
                            <Line type="monotone" dataKey="hml" stroke="#f59e0b" name="Value" dot={false} strokeWidth={1.5} />
                            <Line type="monotone" dataKey="umd" stroke="#8b5cf6" name="Momentum" dot={false} strokeWidth={1.5} />
                            <Line type="monotone" dataKey="qmj" stroke="#ec4899" name="Quality" dot={false} strokeWidth={1.5} />
                          </LineChart>
                        </ResponsiveContainer>
                      </div>
                    )}
