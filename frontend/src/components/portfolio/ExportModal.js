...
import { X, Download, FileText, Receipt, DollarSign, FileSpreadsheet, Loader } from '../icons';
            ...
            return (
              ...
              >
                <div className="export-option-main">
                  <div
                    className={`export-option-icon ${option.colorClass}`}
                  >
                    <Icon size={20} />
                  </div>
