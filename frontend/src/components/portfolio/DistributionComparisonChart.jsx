...
import { AlertTriangle, CheckCircle, ZoomIn, ZoomOut, Maximize2 } from '../icons';
...
function DistributionComparisonChart({ moments, distributionFit, historicalReturns }) {
  ...
  const askAIProps = useAskAI(createChartExtractor(() => ({
    metric: 'distribution_analysis',
    companyName: 'Return Distribution Comparison'
  })));
  ...
  return (
    <div className={`distribution-comparison-chart ${isFullscreen ? 'fullscreen' : ''}`} {...askAIProps}>
      <div className="chart-header">
        <div className="chart-title-section">
          <h4>Normal vs. Reality: Where Models Fail</h4>
          <p className="chart-subtitle">
            Red areas show where Normal distribution underestimates tail probability
          </p>
        </div>
        ...
        >
          ...
          <g transform={`translate(${width - padding.right - 180}, ${padding.top + 15})`}>
            ...
            <line
              ...
              strokeDasharray="8,4"
            />
            <circle cx="27" cy="26" r="4" fill="#059669" />
            <text
              x="50"
              y="30"
              fontSize="12"
            ...
            <line
              ...
              strokeWidth="4"
            />
            <circle cx="27" cy="52" r="4" fill="#DC2626" />
            <text
              x="50"
              y="56"
              fontSize="12"
