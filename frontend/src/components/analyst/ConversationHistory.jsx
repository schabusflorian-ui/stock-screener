...
import {
  History, Trash2, MessageCircle, Clock, ChevronRight, RefreshCw,
...
// Analyst ID to Prism icon mapping
const ANALYST_ICONS = {
  value: BarChart2,
  growth: TrendingUp,
          ...
          {conversations.map(conv => (
            ...
            >
              <div className="history-item-icon">
                {(() => { const AnalystIcon = ANALYST_ICONS[conv.analyst_id] || ANALYST_ICONS.default; return <AnalystIcon size={18} />; })()}
              </div>
