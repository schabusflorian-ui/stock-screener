...
export function CombinedSentimentPanel({ symbol, onRefresh }) {
  ...
  if (loading && !data) {
    return (
      <div className="combined-sentiment-panel">
  ...
  const config = SIGNAL_CONFIG[combined.signal] || SIGNAL_CONFIG.hold;
          ...
          <div className="agreement-section">
            ...
            <div className="agreement-details">
              ...
              <div className="detail-item total">
                <Activity size={14} />
                <span>{combined.sourcesUsed || 0} sources analyzed</span>
              </div>
            </div>
          </div>
...
export default CombinedSentimentPanel;
