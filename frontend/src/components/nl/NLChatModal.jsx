...
import { X, Send, PrismSparkle, Loader2, RefreshCw, MessageSquare, Trash2, ChevronLeft, ChevronRight, Clock, TrendingUp, Building2, Users } from '../icons';
          ...
          <div className="nl-modal-messages">
            {isLoadingHistory ? (
              ...
              <div className="nl-modal-welcome">
                <div className="nl-welcome-icon">
                  <PrismSparkle size={24} />
                </div>
