...
import { Activity, TrendingUp, TrendingDown, RefreshCw, AlertTriangle } from './icons';
...
function MarketSentimentCardComponent({ onRefresh, compact = false }) {
  ...
  // Extract data values (must be before conditional returns to satisfy hook rules)
  const cnn = data?.cnn || {};
  const vix = data?.vix || {};
  const overall = data?.overall || {};

  // Memoize config lookups and calculations (must be before early returns)
