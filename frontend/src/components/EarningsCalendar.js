...
import { Calendar, TrendingUp, TrendingDown, Target, Award, Clock, RefreshCcw, DollarSign } from './icons';
...
export function EarningsCalendar({ symbol }) {
  ...
  // Ask AI context menu for earnings
  const askAIProps = useAskAI(() => ({
    type: 'metric',
    metric: 'earnings',
    symbol,
    label: 'Earnings Calendar',
    nextEarningsDate: data?.nextEarnings?.date,
  ...
  if (loading) {
    return (
      <div className="earnings-calendar-container" {...askAIProps}>
