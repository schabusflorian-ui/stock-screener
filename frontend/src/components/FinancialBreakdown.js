...
function FinancialBreakdown({ symbol, periodType }) {
  ...
  const getCostBreakdown = () => {
    ...
    return [
      { name: 'Cost of Revenue', value: selectedData.costs.costOfRevenue, percent: (selectedData.costs.costOfRevenue / total) * 100, fill: '#ef4444' },
      { name: 'R&D', value: selectedData.costs.researchAndDevelopment, percent: (selectedData.costs.researchAndDevelopment / total) * 100, fill: '#f59e0b' },
      { name: 'SG&A', value: selectedData.costs.sellingGeneralAdmin, percent: (selectedData.costs.sellingGeneralAdmin / total) * 100, fill: '#f97316' },
      { name: 'Taxes', value: selectedData.costs.incomeTaxExpense, percent: (selectedData.costs.incomeTaxExpense / total) * 100, fill: '#ec4899' },
      { name: 'Other', value: selectedData.costs.otherExpenses, percent: (selectedData.costs.otherExpenses / total) * 100, fill: '#6b7280' },
      { name: 'Net Income', value: selectedData.netIncome, percent: (selectedData.netIncome / total) * 100, fill: '#22c55e' }
          ...
          <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <ComposedChart data={marginChartData}>
                ...
                <Line type="monotone" dataKey="Net Margin" stroke="#22c55e" strokeWidth={2} dot={{ r: 4 }} />
              </ComposedChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={revenueChartData}>
                ...
                <Bar dataKey="Gross Profit" fill="#10b981" />
                <Bar dataKey="Operating Income" fill="#8b5cf6" />
                <Bar dataKey="Net Income" fill="#22c55e" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
