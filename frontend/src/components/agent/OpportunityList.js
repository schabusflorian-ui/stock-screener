...
import { TrendingUp, Calendar, MessageSquare, Users, BarChart2, IconButton } from '../icons';
...
const TRIGGER_CONFIG = {
  event: { icon: Calendar, color: 'blue', label: 'Event', colorScheme: 'analytics' },
  sentiment: { icon: MessageSquare, color: 'purple', label: 'Sentiment', colorScheme: 'ai' },
  insider: { icon: Users, color: 'yellow', label: 'Insider', colorScheme: 'risk' },
  technical: { icon: BarChart2, color: 'green', label: 'Technical', colorScheme: 'growth' },
};
    ...
    return (
      <Card variant="base" className={`opportunity-list opportunity-list--empty ${className}`}>
        <div className="opportunity-list__empty">
          <IconButton icon={TrendingUp} colorScheme="growth" size="medium" className="opportunity-list__empty-icon-btn" />
