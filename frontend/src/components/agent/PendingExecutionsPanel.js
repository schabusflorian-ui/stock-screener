...
// Show and manage pending simulated trades awaiting approval (Paper Trading)
...
function PendingExecutionsPanel({ portfolioId }) {
  ...
  if (loading) {
    return (
      <div className="pending-executions loading">
        ...
        <span>Loading pending simulated trades...</span>
      </div>
    );
  }
  ...
  return (
    <div className="pending-executions">
      ...
      <SimulationBadge variant="banner" size="sm" label="Paper Trading Mode" />
      ...
      {stats && (
        <div className="execution-stats">
          <div className="stat-item">
            <span className="stat-label">Simulated Trades</span>
          ...
          <div className="stat-item">
            <span className="stat-label">Virtual Value</span>
        ...
        <div className="executions-content">
          {pending.length === 0 ? (
            <div className="empty-state">
              <Clock size={32} />
              <h4>No Pending Simulated Trades</h4>
              <p>
                When the AI analysis system generates signals that meet your thresholds,
                they will appear here for approval. All trades are simulated (paper trading).
              </p>
      ...
      {activeTab === 'history' && (
        <div className="executions-content">
          {history.length === 0 ? (
            <div className="empty-state">
              <History size={32} />
              <h4>No Simulation History</h4>
              <p>
                Past approved, rejected, and simulated trades will appear here.
              </p>
              <ComplianceDisclaimer variant="compact" type="simulation" />
            </div>
          ) : (
