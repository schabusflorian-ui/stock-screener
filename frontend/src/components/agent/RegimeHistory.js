...
import { TrendingUp, TrendingDown, Minus, Zap, AlertTriangle, Calendar } from 'lucide-react';
 ...
 */
const REGIME_CONFIG = {
  BULL: { color: '#10b981', label: 'Bull', icon: TrendingUp },
  BEAR: { color: '#ef4444', label: 'Bear', icon: TrendingDown },
  SIDEWAYS: { color: '#6366f1', label: 'Sideways', icon: Minus },
  HIGH_VOL: { color: '#f59e0b', label: 'High Vol', icon: Zap },
