...
/**
 * Action configuration - using bullish/bearish terminology for regulatory compliance
 */
const ACTION_CONFIG = {
  ...
  lean_bullish: { label: 'Lean Bullish', variant: 'green', icon: TrendingUp },
  neutral: { label: 'Neutral', variant: 'gray', icon: Minus },
  lean_bearish: { label: 'Lean Bearish', variant: 'red', icon: TrendingDown },
...
function RecommendationRow({ recommendation, expanded, onToggle }) {
  const config = ACTION_CONFIG[recommendation.action] || ACTION_CONFIG.neutral;
