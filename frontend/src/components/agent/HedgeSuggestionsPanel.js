...
// Display hedge recommendations during high-risk regimes
...
const HEDGE_TYPES = {
  index_put: { label: 'Index Put', icon: TrendingDown, color: 'blue' },
  vix_call: { label: 'VIX Call', icon: Activity, color: 'purple' },
  sector_hedge: { label: 'Sector Hedge', icon: Shield, color: 'orange' },
  raise_cash: { label: 'Raise Cash', icon: DollarSign, color: 'green' }
};
  ...
  return (
    <div className="hedge-suggestions">
      ...
      {hedgesNeeded ? (
        <div className="risk-alert warning">
          ...
          <div className="alert-content">
            <strong>Elevated Market Risk Detected</strong>
            <p>
              Current market regime ({regime?.replace('_', ' ')}) suggests considering protective hedges
              for your portfolio.
            </p>
          </div>
        </div>
        ...
        <div className="risk-alert normal">
          <Check size={20} />
          <div className="alert-content">
            <strong>No Hedges Recommended</strong>
            <p>
              Current market conditions do not warrant protective hedging.
      ...
      <div className="info-box">
        <Info size={16} />
        <div>
          <strong>About Hedge Suggestions</strong>
          <p>
            These suggestions are based on your portfolio's beta exposure, current market volatility (VIX),
            and the detected market regime. Hedges are only recommended during HIGH_VOL or CRISIS conditions.
            Always consult with a financial advisor before implementing options strategies.
          </p>
        </div>
      </div>
    </div>
