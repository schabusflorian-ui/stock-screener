...
import { Database, RefreshCw, HardDrive, Table, FileText, IconButton } from '../icons';
    ...
    <div className="database-stats">
      ...
      <div className="stats-overview">
        <div className="stat-card">
          <IconButton icon={HardDrive} colorScheme="analytics" size="small" className="stat-icon-btn" />
        ...
        <div className="stat-card">
          <IconButton icon={Table} colorScheme="ai" size="small" className="stat-icon-btn" />
          <div className="stat-content">
        ...
        <div className="stat-card">
          <IconButton icon={FileText} colorScheme="portfolio" size="small" className="stat-icon-btn" />
          <div className="stat-content">
        ...
        <div className="stat-card">
          <IconButton icon={Database} colorScheme="growth" size="small" className="stat-icon-btn" />
          <div className="stat-content">
