...
function BalanceSheetBreakdown({ symbol, periodType }) {
  ...
  // Ask AI context menu for balance sheet
  ...
  return (
    <div className="balance-sheet-breakdown" {...askAIProps}>
      ...
      {viewMode === 'overview' && selectedData && (
        <div className="bs-overview">
          ...
          {selectedData.dataQuality && !selectedData.dataQuality.balances && (
            <div className={`bs-data-quality-warning ${selectedData.dataQuality.imbalancePct > 50 ? 'critical' : selectedData.dataQuality.imbalancePct > 10 ? 'severe' : 'minor'}`}>
              <span className="warning-icon">⚠️</span>
              <span className="warning-text">
                {selectedData.dataQuality.warning}
                {selectedData.dataQuality.reconciled && ' (Partial data reconciliation applied)'}
              </span>
              <span className="warning-detail">
                Imbalance: {selectedData.dataQuality.imbalancePct.toFixed(1)}%
              </span>
            </div>
          )}
          ...
          <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <AreaChart data={trendData}>
                ...
                />
                <Legend />
                <Area type="monotone" dataKey="Total Assets" fill="#2563EB" stroke="#2563EB" fillOpacity={0.15} />
                <Area type="monotone" dataKey="Total Liabilities" fill="#DC2626" stroke="#DC2626" fillOpacity={0.15} />
                <Area type="monotone" dataKey="Shareholders Equity" fill="#059669" stroke="#059669" fillOpacity={0.15} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={assetCompositionData}>
                ...
                />
                <Legend />
                <Bar dataKey="Current Assets" stackId="a" fill="#0891B2" />
                <Bar dataKey="Non-Current Assets" stackId="a" fill="#2563EB" />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <ComposedChart data={ratioTrendData}>
                ...
                />
                <Legend />
                <Line type="monotone" dataKey="Current Ratio" stroke="#059669" strokeWidth={2} dot={{ r: 4 }} />
                <Line type="monotone" dataKey="Quick Ratio" stroke="#7C3AED" strokeWidth={2} dot={{ r: 4 }} />
                <Line type="monotone" dataKey="Debt to Equity" stroke="#DC2626" strokeWidth={2} dot={{ r: 4 }} />
              </ComposedChart>
            </ResponsiveContainer>
          </div>
        </div>
