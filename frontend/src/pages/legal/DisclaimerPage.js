  ...
  return (
    <LegalPageLayout title="Investment Disclaimer" lastUpdated="2026-01-13">
      <div className="legal-document">
        <div style={{ backgroundColor: '#fef2f2', border: '2px solid #dc2626', borderRadius: '0.5rem', padding: '1.5rem', marginBottom: '2rem' }}>
          <h2 style={{ marginTop: 0, color: '#dc2626' }}>⚠️ PLEASE READ THIS DISCLAIMER CAREFULLY</h2>
          <p style={{ marginBottom: 0 }}><strong>This platform provides information for educational purposes only and does not constitute financial advice.</strong></p>
        </div>
        ...
        <div style={{ backgroundColor: '#fef2f2', padding: '1rem', borderRadius: '0.5rem', marginTop: '1rem' }}>
          <p style={{ marginBottom: 0, fontWeight: 'bold', fontSize: '1.125rem' }}>
            THERE IS NO GUARANTEE THAT YOU WILL MAKE MONEY. INVESTING INVOLVES RISK OF LOSS.
          </p>
        </div>
        ...
        <div style={{ backgroundColor: '#fffbeb', border: '1px solid #fbbf24', borderRadius: '0.5rem', padding: '1rem', marginTop: '2rem' }}>
          <p style={{ marginBottom: 0 }}>
            <strong>IF YOU DO NOT AGREE WITH THIS DISCLAIMER, PLEASE DO NOT USE THE SERVICE.</strong>
          </p>
        </div>
