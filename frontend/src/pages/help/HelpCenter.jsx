...
import {
  ChevronDown, Search, MessageCircle, Book,
  Rocket, Zap, BarChart2, Lock, Settings
          ...
          <div key={category.id} className="faq-category">
            <h2 className="faq-category-title">
              <span className="faq-category-icon">
                {(() => { const IconComponent = FAQ_ICON_MAP[category.iconName]; return IconComponent ? <IconComponent size={20} /> : null; })()}
              </span>
              {category.title}
            </h2>
