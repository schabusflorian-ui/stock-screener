...
function ThesisCard({ thesis: rawThesis, onEdit, onView }) {
  // Destructure to exclude version counts from thesis object
  // eslint-disable-next-line no-unused-vars
  const { version_count, versions_count, ...thesis } = rawThesis;
...
// Note Card Component
function NoteCard({ note: rawNote, onEdit, onPin, onDelete, onView }) {
  // Destructure to exclude numeric count fields that shouldn't be displayed
  // eslint-disable-next-line no-unused-vars
  const { version_count, versions_count, reading_time_minutes, word_count, links_count, attachments_count, ...note } = rawNote;
