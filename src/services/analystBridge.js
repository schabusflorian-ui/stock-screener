...
const ANALYSTS = {
  ...
  tech: {
    ...
    greeting: "Hello, I'm Elena, your Technology & Disruption Analyst. I specialize in understanding how technology transforms industries and creates investment opportunities. What technology investment should we analyze?",
    suggested_questions: [
...
class AnalystService {
  ...
  async *chatStream(conversationId, message, companyContext = null) {
    ...
    const enrichedContext = await this._enrichWithFactors(companyContext, conv.analyst_id);
