...
if (tableExists(db, 'user_preferences')) {
  if (!columnExists(db, 'user_preferences', 'analytics_opted_in')) {
  ...
  if (!columnExists(db, 'user_preferences', 'feedback_prompts_enabled')) {
  ...
  if (!columnExists(db, 'user_preferences', 'last_feedback_prompt_at')) {
  ...
  if (!columnExists(db, 'user_preferences', 'feedback_prompt_cooldown_days')) {
