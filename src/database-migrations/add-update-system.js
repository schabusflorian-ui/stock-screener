...
function migrate() {
  ...
  const jobs = [
    ...
    // IPO BUNDLE
    ['ipo', 'ipo.sync_trading_companies', 'Sync Trading IPOs', 'Create company records for trading IPOs without company_id', '0 6 * * *', 1, 50, 1000, 3600],
    ['ipo', 'ipo.check_status', 'IPO Status Check', 'Check and update IPO status based on trading dates', '0 7 * * 1-5', 1, 100, 500, 1800],
